...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
   ...
   *
   * <p>// @param request Function returning the request to apply
   *
  ...
  private final SwerveRequest.FieldCentricFacingAngle m_faceAngle = new SwerveRequest.FieldCentricFacingAngle()
          .withDriveRequestType(SwerveModule.DriveRequestType.OpenLoopVoltage); // Or OpenLoopDutyCycle
  ...
  public void driveToAngle(int location) {
    ...
    drivetrain.setControl(
            m_faceAngle
                    ...
                    .withTargetDirection(new Rotation2d(Math.atan2(cosmicConverterX-drivetrain.getState().Pose.getX(),cosmicConverterY-drivetrain.getState().Pose.getY()))
    ));
  }
}
